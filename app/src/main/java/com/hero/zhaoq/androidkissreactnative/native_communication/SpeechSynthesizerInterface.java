...
public class SpeechSynthesizerInterface extends ReactContextBaseJavaModule {
    ...
    public SpeechSynthesizerInterface(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void init() {
        ...
        SpeechUtility.createUtility(this.context, "appid=5c8a6d71");
